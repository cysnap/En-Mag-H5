...
<head>
	...
	<title><?php if(is_single() || is_page() || is_archive() || is_404() || is_search()) : wp_title('_',true,'right'); endif; bloginfo('name'); echo " - " . bloginfo('description');  if( $paged == "" ) $pagenum = "";else echo $pagenum = " - Page: ".$paged; ?></title>
